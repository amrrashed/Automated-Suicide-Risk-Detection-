...
a=df.describe()
X = df.iloc[:,0:1056] #512 for resnet18 and 2048 for resnet50 and 1280 for effiecientnetb0
# integer encode
y = df.iloc[:,1056] #512 for resnet18 and 2048 for resnet50 and 1280 for effiecientnetb0
...
for kernel in kernels:
    ...
    for result in optimizer.res:
     ...
     df.to_csv('nasnetmobile_features_original.csv', index=False)
